                ...
                <SafeAreaView style={styles.safeArea}>
                    ...
                    <View style={[styles.searchBarContainer]}>
                        ...
                        <View style={{ marginHorizontal: 4, display: "flex", justifyContent: "space-around", top: 100, }}>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "space-between", marginHorizontal: 4, top: 270, }}>
                            ...
                            <View style={{ flexDirection: "row", justifyContent: "space-between", marginHorizontal: 4, top: 320 }}>
                                <View style={{ flexDirection: "row", paddingHorizontal: 2, alignItems: "center" }}>
                    ...
                    {/**Dailt forecast */}
                    <View style={{ marginBottom: 2, paddingVertical: 3, top: 550 }}>
